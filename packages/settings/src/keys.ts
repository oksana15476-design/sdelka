...
/**
 * Почему применена именно эта версия. Исход всегда назван ключом, включая
 * «ни одной»: молчаливое `null` не отличает «версии не было» от «версия ещё не
 * вступила в силу», а на экране владельца это разные ответы.
 */
export const SETTINGS_OUTCOME_KEYS = {
  ...
  /** Действующей версии нет: журнал пуст либо момент раньше первой версии. */
  noVersionInEffect: 'settings.resolution.none_in_effect',
