 ...
 *
 * Автор и основание в тестах этого пакета не меняются: их правила проверяет
 * `@sdelka/settings`, и повторять там же проверенное здесь значило бы завести
 * второе место, где они якобы проверяются.
 */
